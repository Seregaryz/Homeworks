...
class FIFAFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tv_first_fr_sixth.text = arguments?.getString("FIRST").toString()
        tv_sec_fr_sixth.text = arguments?.getString("SEC").toString()
        tv_third_fr_sixth.text = arguments?.getString("THIRD").toString()
    }
